...
{
    int gdim = 2;
    std::vector<double> ls_values = {-0.1,0.2};

    cell::type cell_type = cell::type::interval;
    std::vector<double> vertex_coordinates = {0.,0.,1.,0.};
    ...
    std::cout << "Flag=" << get_entity_flag(ls_values, false) << std::endl;
