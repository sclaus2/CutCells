...
print("vertex_coords=", cut_cell_int.vertex_coords)
...
print("vertex_coords=", cut_cell_ext.vertex_coords)
print("connectivity=", cut_cell_ext.connectivity)
print("types=", cut_cell_ext.types)
